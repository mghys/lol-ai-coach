...
def create_checked_heroes():
    ...
    heros_dir = os.path.join(base_dir, "data", "hero_identification_data", "heros")
    checked_dir = os.path.join(
        base_dir, "data", "hero_identification_data", "heros_checked"
    )
